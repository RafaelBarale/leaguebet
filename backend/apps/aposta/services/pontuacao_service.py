...
def cadastrar_pontuacao(pontuacao_nova):
    return Pontuacao.objects.create(campeonato=pontuacao_nova.campeonato, vencedor=pontuacao_nova.vencedor, golCasa=pontuacao_nova.golCasa, golVisitante=pontuacao_nova.golVisitante)
